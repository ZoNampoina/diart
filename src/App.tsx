...
function App() {
  ...
  const openSong=(s:Song,origin?:{page:Page;label:string})=>{
    ...
    const fallback:Record<string,string>={dashboard:'Accueil',library:'Bibliothèque',artist:selectedArtist||'Artiste',artists:'Artistes',favorites:'Favoris',recent:'Récents',setlist:currentSetlist?.name||'Setlist',setlists:'Setlists',authors:'Auteurs'}
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      <div className="content">
        ...
        {page==='authors'&&<PeoplePage title="Auteurs / Compositeurs" items={authorGroups} onOpen={s=>openSong(s,{page:'authors',label:'Auteurs'})}/>}
