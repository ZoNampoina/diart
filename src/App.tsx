...
function SongLyricsMark({song,compact=false}:{song:Song;compact?:boolean}){
  ...
  return <em className={'song-lyrics-mark'+(compact?' compact':'')} title="Paroles disponibles"><BookOpen size={12}/><span>Paroles</span></em>
}
